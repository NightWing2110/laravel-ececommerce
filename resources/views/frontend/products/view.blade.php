            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <label class="me-3">Orginal Price : <s>Rs {{ number_format($products->original_price).' VNĐ' }}</s></label>
                        <label class="fw-bold">Selling Price :Rs {{ number_format($products->selling_price).' VNĐ' }}</label>
